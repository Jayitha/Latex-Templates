...
\author[1]{Jayitha Cherapanamjeri}

\affil[1]{International Institute of Information Technology. \newline \url{jayitha.c@research.iiit.ac.in}}
...
\begin{enumerate}
    ...
    \item Certificates
    \item Applications in db
    \item Other papers read
    \item Results
\end{enumerate}
...
\begin{table}[bt]
\sidecaption{Automobile Land Speed Records (GR 5-10). Source: \url{https://www.sedl.org/afterschool/toolkits/science/pdf/ast_sci_data_tables_sample.pdf}}
\label{tab:example}
\centering
\resizebox{\textwidth}{!}{
